...
/// Parameters for an iPhone 6p device.
public static readonly Screen ELEC4547VRG = new Screen
{
    width = 0.1325f,
    height = 0.0745f,
    border = 0.004f
  ...
  public static readonly Device GoggleTechC1Glass = new Device {
    ...
    /// Parameters for a Cardboard v2.
    public static readonly Device VRGELEC4547 = new Device
    {
        lenses = {
        separation = 0.06f,
        offset = 0.035f,
